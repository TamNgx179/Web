...
Quản lý mã nguồn:
-  GitHub Repository: [Web - GitHub](https://github.com/TamNgx179/Web)
...
├── DATA/            # Lưu dữ liệu dưới dạng file JSON về danh sách xe, thương hiệu, thông tin chi tiết
├── HTML/            # Chứa các trang giao diện chính như Home.html, About_us.html,...
├── Image_icon/      # Lưu các biểu tượng nhỏ (icon xe, logo thương hiệu, favicon, ...)
├── JavaScript/      # Chứa các script xử lý logic hiển thị, hiệu ứng động, và tương tác người dùng     
├── images/          # Lưu hình ảnh hiển thị trong Website (ảnh xe, banner, nền trang, ...)
...
1. Clone dự án về máy:
   ```bash
   git clone https://github.com/TamNgx179/Web.git
   ```
...
- Thêm tính năng đánh giá xe, bình luận, so sánh xe.  
- Thêm tính năng hỗ trợ đa ngôn ngữ
- Thêm giao diện cho phép nhắn tin với nhân viên hỗ trợ
